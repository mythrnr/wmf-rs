...
macro_rules! impl_parser {
    ($t:ident,u8) => {
        $crate::constants::impl_parser!(_, $t, u8, 1, 4);
    };
    ($t:ident,u16) => {
        $crate::constants::impl_parser!(_, $t, u16, 2, 6);
    };
    ($t:ident,u32) => {
        $crate::constants::impl_parser!(_, $t, u32, 4, 10);
    };
    ($t:ident,i32) => {
        $crate::constants::impl_parser!(_, $t, i32, 4, 10);
    };
        ...
        paste::paste! {
            impl $t {
                ...
                pub fn parse<R: ::std::io::Read>(
                    ...
                    let (value, consumed_bytes) = crate::[<read_ $raw _from_le_bytes>](buf)?;
