...
pub struct Font {
    ...
    pub charset: crate::CharacterSet,
    ...
    pub out_precision: crate::OutPrecision,
    ...
    /// Flags.
    pub clip_precision: crate::ClipPrecision,
    ...
    pub pitch_and_family: crate::PitchAndFamily,
...
impl Font {
    ...
    pub fn parse<R: std::io::Read>(
        ...
        let (
            ...
            crate::read_i16_from_le_bytes(buf)?,
            {
                let (v, c) = crate::read_u8_from_le_bytes(buf)?;
                (v == 0x01, c)
            },
            {
                let (v, c) = crate::read_u8_from_le_bytes(buf)?;
            ...
            crate::CharacterSet::parse(buf)?,
            crate::OutPrecision::parse(buf)?,
            crate::ClipPrecision::parse(buf)?,
            crate::FontQuality::parse(buf)?,
            crate::PitchAndFamily::parse(buf)?,
        );
