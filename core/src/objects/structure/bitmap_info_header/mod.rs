...
pub enum BitmapInfoHeader {
    ...
    V4 {
        ...
        color_space_type: crate::LogicalColorSpace,
    ...
    V5 {
        ...
        intent: crate::GamutMappingIntent,
...
impl BitmapInfoHeader {
    ...
    pub fn bit_count(&self) -> crate::BitCount {
        match self {
