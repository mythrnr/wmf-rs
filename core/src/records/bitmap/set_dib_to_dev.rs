...
pub struct META_SETDIBTODEV {
    ...
    pub dib: crate::DeviceIndependentBitmap,
}
...
impl META_SETDIBTODEV {
    ...
    pub fn parse<R: std::io::Read>(
        ...
        crate::records::check_lower_byte_matches(
            record_function,
            crate::RecordType::META_SETDIBTODEV,
        )?;
        ...
        let (dib, c) = crate::DeviceIndependentBitmap::parse_with_color_usage(
            buf,
            color_usage,
        )?;
