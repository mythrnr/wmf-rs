...
pub enum META_ESCAPE {
    ...
    CLIP_TO_PATH {
        ...
        clip_function: crate::PostScriptClipping,
    ...
    GET_PS_FEATURESETTING {
        ...
        feature: crate::PostScriptFeatureSetting,
    },
...
impl META_ESCAPE {
    ...
    pub fn parse<R: std::io::Read>(
        ...
        crate::records::check_lower_byte_matches(
            record_function,
            crate::RecordType::META_ESCAPE,
        )?;

        let (escape, escape_bytes) = crate::MetafileEscapes::parse(buf)?;
        record_size.consume(escape_bytes);

        let record = match escape {
            crate::MetafileEscapes::ABORTDOC => {
                Self::parse_as_ABORTDOC(buf, record_size, record_function)?
            }
            crate::MetafileEscapes::BEGIN_PATH => {
                Self::parse_as_BEGIN_PATH(buf, record_size, record_function)?
            }
            crate::MetafileEscapes::CHECKJPEGFORMAT => {
            ...
            crate::MetafileEscapes::CHECKPNGFORMAT => {
            ...
            crate::MetafileEscapes::DRAWPATTERNRECT => {
            ...
            crate::MetafileEscapes::ENCAPSULATED_POSTSCRIPT => {
            ...
            crate::MetafileEscapes::GETEXTENDEDTEXTMETRICS => {
            ...
            crate::MetafileEscapes::GETFACENAME => {
                Self::parse_as_GETFACENAME(buf, record_size, record_function)?
            }
            crate::MetafileEscapes::GETPAIRKERNTABLE => {
            ...
            crate::MetafileEscapes::GETPHYSPAGESIZE => {
            ...
            crate::MetafileEscapes::GETPRINTINGOFFSET => {
            ...
            crate::MetafileEscapes::GET_PS_FEATURESETTING => {
            ...
            crate::MetafileEscapes::GETSCALINGFACTOR => {
            ...
            crate::MetafileEscapes::META_ESCAPE_ENHANCED_METAFILE => {
            ...
            crate::MetafileEscapes::METAFILE_DRIVER => {
            ...
            crate::MetafileEscapes::POSTSCRIPT_IDENTIFY => {
            ...
            crate::MetafileEscapes::POSTSCRIPT_IGNORE => {
            ...
            crate::MetafileEscapes::POSTSCRIPT_INJECTION => {
            ...
            crate::MetafileEscapes::POSTSCRIPT_PASSTHROUGH => {
            ...
            crate::MetafileEscapes::OPENCHANNEL => {
                Self::parse_as_OPENCHANNEL(buf, record_size, record_function)?
            }
            crate::MetafileEscapes::QUERYDIBSUPPORT => {
            ...
            crate::MetafileEscapes::QUERYESCSUPPORT => {
            ...
            crate::MetafileEscapes::STARTDOC => {
